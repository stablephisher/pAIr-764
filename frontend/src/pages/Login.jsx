...
import { Shield, Loader2, AlertCircle, Zap } from 'lucide-react';
...
export default function LoginPage({ onBack }) {
    ...
    return (
        <div className="flex items-center justify-center px-4 py-16 animate-fade-in-up">
            <div className="max-w-md w-full">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-bold mb-3" style={{ color: 'var(--text)' }}>{t('Welcome to pAIr', lang)}</h1>
                    <p className="text-lg" style={{ color: 'var(--text-secondary)' }}>
                        {t('AI-powered compliance navigator for Indian MSMEs.', lang)}
                    </p>
                </div>
                ...
                <div className="card p-8" style={{ border: '1px solid var(--border)' }}>
                    <button onClick={login} disabled={loading}
                        ...
                        {loading ? t('Loading...', lang) : t('Continue with Google', lang)}
                    </button>
                    ...
                    <p className="text-xs text-center mt-6" style={{ color: 'var(--text-tertiary)' }}>
                        {t('By continuing, you agree to our Terms and Privacy Policy', lang)}
                    </p>
                </div>
